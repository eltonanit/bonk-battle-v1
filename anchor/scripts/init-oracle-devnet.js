...
async function main() {
  ...
  // SOL price in micro-USD (es: $200 = 200_000_000)
  const solPriceUsd = 200_000_000;
  
  console.log('💰 SOL Price: $200 (hardcoded for test)');
  ...
  console.log('✅ Oracle initialized on DEVNET!');
